...
[![GitHub Tests Action Status](https://github.com/spatie/package-laravel-podman-laravel/actions/workflows/run-tests.yml/badge.svg)](https://github.com/foxws/laravel-podman/actions?query=workflow%3Arun-tests+branch%3Amain)
[![GitHub Code Style Action Status](https://github.com/spatie/package-laravel-podman-laravel/actions/workflows/fix-php-code-style-issues.yml/badge.svg)](https://github.com/foxws/laravel-podman/actions?query=workflow%3A"Fix+PHP+code+style+issues"+branch%3Amain)
...
```php
$podman = new Foxws\Podman();
echo $podman->echoPhrase('Hello, Foxws!');
```
